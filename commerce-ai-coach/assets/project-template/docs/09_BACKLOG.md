...
- Case and proposal status enums match `02_ARCHITECTURE.md` §4 exactly, and the transition tables are encoded as data that rejects unlisted transitions.
