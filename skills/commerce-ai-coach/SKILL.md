...
- status values from `docs/02-architecture.md` §4 only.
...
- **A linked reference file is missing:** use `learning/curriculum.md` (modes, hint ladder, mastery) and `learning/progress-protocol.md` from the repository.
