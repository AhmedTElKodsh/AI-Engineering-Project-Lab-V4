...
REQUIRED = [
    ...
    'docs/curriculum.md', 'docs/teaching-guide.md', 'docs/lesson-template.md',
    'docs/engineering-guide.md', 'docs/assessment-cards.md',
    'docs/progress-protocol.md', 'docs/portfolio.md', 'docs/provider-reference.md',
