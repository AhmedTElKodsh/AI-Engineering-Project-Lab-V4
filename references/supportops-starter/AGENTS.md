...
The active authorities are `docs/curriculum.md`, `docs/teaching-guide.md`, `docs/lesson-template.md`, `docs/engineering-guide.md`, `docs/progress-protocol.md`, and `docs/assessment-cards.md`. Product destination details live under `docs/project/` and must not be turned into early prerequisites.
